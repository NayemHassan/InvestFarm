        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row row-cols-auto g-3">
                    <div class="col-12">
                    <form class="row g-3" action="{{ route('investment.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <!-- Name -->
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"> Investment Type Name</label>
                                <input type="text" class="form-control" name="type" id="inputFirstName" value="{{ old('type') }}">
                                @error('type')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="unmber" class="form-control" name="amount" id="inputPhone" value="{{ old('amount') }}">
                                @error('amount')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 pb-2">
                                ...
                                <textarea class="form-control" id="inputDescription" name="details" placeholder="Details..." rows="3">{{ old('details') }}</textarea>
                                @error('details')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
