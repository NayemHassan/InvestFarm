...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            <a type="button" href="{{route('view.savings')}}" class="btn btn-primary" >View Savings </a>
        </div>
    </div>
</div>
<div class="row">
                        ...
                        <form class="row g-3" action="" method="post" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="amount" class="form-control" name="number" id="inputLastName" >
                                </div>
                                
                                <div class="col-12 pb-2">
                                    <label for="inputAddress" class="form-label">Note</label>
                                    <textarea class="form-control" id="inputAddress" name="note" placeholder="Note..." rows="3"></textarea>
                                </div>
                                <div class="col-12">
